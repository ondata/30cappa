...
mlr --c2t cut -f PRO_COM_T,COD_REG then filter -S '$COD_REG=="19"' "$folder"/../../dati/arigadicomando/comuni_30cappa_5mila.CSV | tail -n +2 >"$folder"/../../dati/arigadicomando/lista19.tsv
...
done <"$folder"/../../dati/arigadicomando/lista19.tsv
